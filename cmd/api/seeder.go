...
func seedDB(db *gorm.DB) {
	...
	mechanics := []models.Mechanic{
		...
		{FullName: "Daniel Osariemen", Email: "osazeepeter79@gmail.com", PhoneNumber: "08061909748", Password: string(hashedPassword2), IsEmailVerified: true, Specialty: "Repair Engines", Experience: 3, IsAvailable: true},
	}
